...
Blockly.JavaScript.init = function(a) {
   ...
   // b.length && (Blockly.JavaScript.definitions_.variables = "int " + b.join(", ") + ";")
};
...
Blockly.JavaScript.setup_loop = function(a) {
    Blockly.JavaScript.setups_["setup_block"] = Blockly.JavaScript.statementToCode(a, "DO");
    var d = Blockly.JavaScript.statementToCode(a, "DO1");
...
Blockly.JavaScript.text_append = function(a) {
    var b = Blockly.JavaScript.valueToCode(a, "TEXT1", Blockly.JavaScript.ORDER_NONE) || "''";
    a = Blockly.JavaScript.valueToCode(a, "TEXT2", Blockly.JavaScript.ORDER_NONE) || "''";
    var code =  "String(" + b + ") + String(" + a + ")\n"

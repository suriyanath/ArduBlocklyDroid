...
goog.provide = function(a) {
    if (goog.isInModuleLoader_()) throw Error("goog.provide can not be used within a module.");
...
goog.module.get = function(a) {
    if (!COMPILED && a in goog.loadedModules_) {
        if (goog.loadedModules_[a].type != goog.ModuleType.GOOG) throw Error("Can only goog.module.get for goog.modules.");
        if (goog.loadedModules_[a].moduleId != a) throw Error("Cannot goog.module.get by path.");
    }
...
goog.require = function(a) {
    if (goog.isPath_(a))
        if (goog.isInGoogModuleLoader_()) {
            if (!goog.getModulePath_()) throw Error("Current module has no path information. Was it loaded via goog.loadModule without a path argument?");
...
goog.loadModule = function(a, b) {
    ...
    try {
        ...
        else if (goog.isString(a)) goog.useSafari10Workaround() && (a = goog.workaroundSafari10EvalBug(a)), d = goog.loadModuleFromSource_.call(void 0, a);
        else throw Error("Invalid module definition");
        var e = goog.moduleLoaderState_.moduleName;
        if (goog.isString(e) && e) {
            goog.moduleLoaderState_.declareLegacyNamespace ?
                goog.constructNamespace_(e, d) : goog.SEAL_MODULE_EXPORTS && Object.seal && "object" == typeof d && null != d && Object.seal(d);
            var f = {
                exports: d,
                type: goog.ModuleType.GOOG,
...
!COMPILED && goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function() {
        ...
        var c = {
            ...
            d = !1,
            e = goog.global.navigator && goog.global.navigator.userAgent ?
        ...
        this.deferredQueue_ = []
    }, goog.DebugLoader_.prototype.bootstrap = function(a,
        b) {
        function c() {
        ...
        if (this.getPathFromDeps_(a)) {
            var b = this,
                ...
                d = function(a) {
                    ...
                    if (!e) throw Error("Bad dependency path or symbol: " +
                        a);
                    if (!b.written_[e]) {
                        b.written_[e] = !0;
                        a = b.dependencies_[e];
    ...
    }, goog.LoadController = function() {}, goog.LoadController.prototype.pause =
    function() {}, goog.LoadController.prototype.resume = function() {}, goog.LoadController.prototype.loaded = function() {}, goog.LoadController.prototype.pending = function() {}, goog.LoadController.prototype.registerEs6ModuleExports = function(a, b) {}, goog.LoadController.prototype.setModuleState = function(a, b) {}, goog.LoadController.prototype.clearModuleState = function() {}, goog.LoadController.prototype.defer = function(a) {}, goog.LoadController.prototype.areDepsLoaded = function() {}, goog.Dependency = function(a, b, c, d, e) {
        ...
        goog.Dependency.callbackMap_[b] =
            a;
        return b
        ...
        if (goog.global.CLOSURE_IMPORT_SCRIPT) goog.global.CLOSURE_IMPORT_SCRIPT(this.path) ?
            ...
            if (!goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING && goog.isDocumentLoading_()) {
                ...
                goog.DebugLoader_.IS_OLD_IE_ ? (a.pause(), d.onreadystatechange = function() {
                    if ("loaded" == d.readyState || "complete" == d.readyState) a.loaded(), a.resume()
                }) : d.onload = function() {
                    d.onload =
                        null;
                    a.loaded()
        ...
        } else goog.logToConsole_("Cannot use default debug loader outside of HTML documents."), "deps.js" == this.relativePath ? (goog.logToConsole_("Consider setting CLOSURE_IMPORT_SCRIPT before loading base.js, or seting CLOSURE_NO_DEPS to true."), a.loaded()) : a.pause()
        ...
        if (!goog.global.CLOSURE_IMPORT_SCRIPT && goog.inHtmlDocument_() && goog.isDocumentLoading_()) {
            var b = goog.global.document,
                c = this,
                d = goog.Dependency.registerCallback_(function() {
        ...
        function b(b) {
            if (c.contents_) {
                ...
                try {
                    var e = c.contents_;
                    c.contents_ = null;
                    b ? goog.globalEval(e) : goog.global.document.write('<script type="text/javascript">' +
                        goog.protectScriptTag_(e) + "\x3c/script>")
                } finally {
        ...
        if (this.contents_ = goog.loadFileSync_(this.path))
            if (this.contents_ = this.transform(this.contents_)) this.contents_ += "\n//# sourceURL=" + this.path;
        if (this.contents_)
            if (goog.global.CLOSURE_IMPORT_SCRIPT) goog.global.CLOSURE_IMPORT_SCRIPT("", this.contents_) ? (this.contents_ = null, a.loaded()) : a.pause();
            else {
                var c = this,
                    d = this.loadFlags.module == goog.ModuleType.ES6;
                if (1 < a.pending().length && goog.DebugLoader_.IS_OLD_IE_) a.defer(function() {
                    b(!0)
                });
                else if (d && goog.inHtmlDocument_() && goog.isDocumentLoading_()) {
                    var e = goog.global.document;
                    a.pause();
                    var f = e.onreadystatechange;
                    e.onreadystatechange = function() {
                        if (e.attachEvent ? "complete" == e.readyState : "interactive" == e.readyState) e.onreadystatechange = f, b(!0), a.resume();
                        goog.isFunction(f) && f.apply(void 0, arguments)
                    }
                } else b(goog.DebugLoader_.IS_OLD_IE_ || !goog.inHtmlDocument_() ||
    ...
    function(a) {
        ...
        if (e.module == goog.ModuleType.ES6) throw Error("ES6 modules are not currently supported by the debug loader.");
...
goog.math.longestCommonSubsequence = function(a, b, c, d) {
    ...
    var m = [];
    h = e;
    for (k = f; 0 < h && 0 < k;) c(a[h - 1], b[k - 1]) ? (m.unshift(d(h - 1, k - 1)), h--, k--) : g[h - 1][k] > g[h][k - 1] ? h-- : k--;
    return m
};
...
Blockly.Events.Ui = function(a, b, c, d) {
    a && (Blockly.Events.Ui.superClass_.constructor.call(this), this.blockId = a.id, this.workspaceId = a.workspace.id, this.element = b, this.oldValue = c, this.newValue = d, this.recordUndo = !1)
};
...
Blockly.utils.wrapLine_ = function(a, b) {
    ...
    do {
        ...
        var h = [],
            k = c.length / e,
            m = 1;
        for (d = 0; d < c.length - 1; d++) m < (d + 1.5) / k ? (m++, h[d] = !0) : h[d] = !1;
        ...
        e = function(c) {
            Blockly.Variables.promptName(Blockly.Msg.NEW_VARIABLE_TITLE, c, function(c) {
                if (c) {
                    ...
                    if (f) {
                        var g = c.toLowerCase();
                        if (f.type == d) var m = Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace("%1", g);
                        else m = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE, m = m.replace("%1", g).replace("%2", f.type);
...
Blockly.Xml.workspaceToDom = function(a, b) {
    var c = goog.dom.createDom("xml"),
        d = Blockly.Variables.allUsedVarModels(a);
    d.length && c.appendChild(Blockly.Xml.variablesToDom(d));
    d = a.getTopBlocks(!0);
    for (var e = 0, f; f = d[e]; e++) c.appendChild(Blockly.Xml.blockToDomWithXY(f, b));
    return c
};
    ...
    try {
        for (var h = 0; h < e; h++) {
            ...
            if ("block" == m || "shadow" == m && !Blockly.Events.recordUndo) {
                ...
                c.push(p.id);
                var l = k.hasAttribute("x") ? parseInt(k.getAttribute("x"), 10) : 10,
                    n = k.hasAttribute("y") ? parseInt(k.getAttribute("y"), 10) : 10;
                isNaN(l) || isNaN(n) || p.moveBy(b.RTL ? d - l : l, n);
                g = !1
            } else if ("shadow" == m) goog.asserts.fail("Shadow block cannot be a top-level block."), g = !1;
            else if ("variables" == m) {
...
Blockly.Xml.appendDomToWorkspace = function(a, b) {
    ...
    if (d && d.height) {
        ...
        b.RTL && (m = b.getWidth());
        for (d = 0; d <
            c.length; d++) b.getBlockById(c[d]).moveBy(b.RTL ? m - f : f, e)
    }
    return c
};
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function(a) {
    function b(a) {
        if (a.isDeletable()) n = n.concat(a.getDescendants());
        else {
            a = a.getChildren();
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        ...
        if (this.options.collapse) {
            for (var k = h = !1, m = 0; m < e.length; m++)
                for (var p = e[m]; p;) p.isCollapsed() ? h = !0 : k = !0, p = p.getNextBlock();
            var l = function(a) {
        ...
        h = {
            text: 1 == n.length ? Blockly.Msg.DELETE_BLOCK : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(n.length)),
            enabled: 0 < n.length,
            callback: function() {
                g.currentGesture_ && g.currentGesture_.cancel();
                2 > n.length ? c() : Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", n.length), function(a) {
                    a &&
                        c()
                })
            }
...
Blockly.Block.prototype.jsonInit = function(a) {
    ...
    if (Array.isArray(a.extensions))
        for (a = a.extensions, c = 0; c < a.length; ++c) Blockly.Extensions.apply(a[c], this, !1)
};
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, m = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++)
        if (l.isVisible()) {
            if (m && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT) var n = c[c.length - 1];
            else k = l.type, n = [], n.type = m &&
                l.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : l.type, n.height = 0, c.push(n);
            n.push(l);
            ...
            m || p != b.length - 1 ? !m && l.type == Blockly.INPUT_VALUE && b[p + 1] && b[p + 1].type ==
            ...
            n.type != Blockly.BlockSvg.INLINE && (n.type == Blockly.NEXT_STATEMENT ?
                (g = !0, e = Math.max(e, l.fieldWidth)) : (n.type == Blockly.INPUT_VALUE ? f = !0 : n.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, l.fieldWidth)))
        }
    for (a = 0; n = c[a]; a++)
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function() {
        if (!e.isDragging()) {
            ...
            if (a.contentTop < d || a.contentTop +
                ...
                for (var k = e.getTopBlocks(!1), m = 0, p; p = k[m]; m++) {
                    ...
                    0 > q && p.moveBy(0, q);
                    q = 25 + c - l.x - (b.RTL ? 0 : n.width);
                    0 < q && p.moveBy(q, 0);
                    l = c + a.viewWidth - 25 - l.x + (b.RTL ? n.width : 0);
                    0 > l && p.moveBy(l, 0)
                }
        }
    });
...
Blockly.bindEventWithChecks_ = function(a, b, c, d, e, f) {
    var g = !1,
        ...
        k = [];
    if (window && window.PointerEvent && b in Blockly.Touch.TOUCH_MAP)
        for (var m = 0, p; p = Blockly.Touch.TOUCH_MAP[b][m]; m++) a.addEventListener(p, h, !1), k.push([a, p, h]);
        ...
        for (m = 0; p = Blockly.Touch.TOUCH_MAP[b][m]; m++) a.addEventListener(p, l, !1), k.push([a, p, l])
    }
    return k
};
